...
// const numbers = [12,34,23]

// const akakar = fruits.concat(flowers,numbers)
// const akakar = flowers.concat(fruits)
// console.log(fruits)
// console.log(flowers)
// console.log(akakar)
...
// console.log(flowers.includes("krisnochura"))
...
// const a = [2,3,4]
// console.log(a.join(""))
// const flowers = ["golap","shapla","joba","beli","krisnochura"];
// console.log(flowers.slice(1,5))
// slice(1,3)
